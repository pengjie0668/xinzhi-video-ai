...
"""
Xinzhi Video AI FastAPI Application
...
from api.dependencies import shutdown_xinzhi_video_ai
...
async def lifespan(app: FastAPI):
    ...
    """
    # Startup
    logger.info("🚀 Starting Xinzhi Video AI API...")
    await task_manager.start()
    logger.info("✅ Xinzhi Video AI API started successfully\n")
    
    yield
    
    # Shutdown
    logger.info("🛑 Shutting down Xinzhi Video AI API...")
    await task_manager.stop()
    await shutdown_xinzhi_video_ai()
    logger.info("✅ Xinzhi Video AI API shutdown complete")


# Create FastAPI app
app = FastAPI(
    title="Xinzhi Video AI API",
    description="""
    ## Xinzhi Video AI - AI Video Generation Platform API
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Start Xinzhi Video AI API Server")
