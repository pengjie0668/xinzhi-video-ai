...
from xinzhi_video_ai.utils.tts_util import get_audio_duration
...
async def tts_synthesize(
    ...
    xinzhi_video_ai: XinzhiVideoAIDep
):
    """
    ...
    ```json
    {
        "text": "Hello, welcome to Xinzhi Video AI!",
    ...
    try:
        ...
        # Call TTS service
        audio_path = await xinzhi_video_ai.tts(**tts_params)
