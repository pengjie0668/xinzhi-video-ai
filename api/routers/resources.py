...
from api.dependencies import XinzhiVideoAIDep
...
from xinzhi_video_ai.utils.os_util import list_resource_files, get_root_path, get_data_path
from xinzhi_video_ai.utils.template_util import get_all_templates_with_info

router = APIRouter(prefix="/resources", tags=["Resources"])


@router.get("/workflows/tts", response_model=WorkflowListResponse)
async def list_tts_workflows(xinzhi_video_ai: XinzhiVideoAIDep):
    """
    ...
    try:
        ...
        all_workflows = xinzhi_video_ai.tts.list_workflows()
...
async def list_media_workflows(xinzhi_video_ai: XinzhiVideoAIDep):
    """
...
async def list_image_workflows(xinzhi_video_ai: XinzhiVideoAIDep):
    """
