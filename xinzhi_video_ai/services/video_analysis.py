...
class VideoAnalysisService(ComfyBaseService):
    ...
    Usage:
        ...
        description = await xinzhi_video_ai.video_analysis("path/to/video.mp4")
        
        # Use local ComfyUI (future)
        description = await xinzhi_video_ai.video_analysis(
            "path/to/video.mp4",
            source="selfhost"
        )
        
        # List available workflows
        workflows = xinzhi_video_ai.video_analysis.list_workflows()
    """
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            description = await xinzhi_video_ai.video_analysis("temp/01_segment.mp4")
        ...
        """
        from xinzhi_video_ai.utils.workflow_util import resolve_workflow_path
