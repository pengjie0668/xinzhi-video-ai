...
from xinzhi_video_ai.models.storyboard import Storyboard, StoryboardFrame, StoryboardConfig


class FrameProcessor:
    """Frame processor"""
    
    def __init__(self, xinzhi_video_ai_core):
        """
        Initialize
        
        Args:
            xinzhi_video_ai_core: XinzhiVideoAICore instance
        """
        self.core = xinzhi_video_ai_core
    ...
    async def _step_generate_audio(
        ...
        from xinzhi_video_ai.utils.os_util import get_task_frame_path
