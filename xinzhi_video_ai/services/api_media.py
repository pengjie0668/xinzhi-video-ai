...
from xinzhi_video_ai.models.media import MediaResult
from xinzhi_video_ai.utils.os_util import get_output_path


class APIProviderMediaService:
    """Adapter from Xinzhi Video AI media calls to direct provider API clients."""
    ...
    VIDEO_MODEL_CAPABILITIES: dict[tuple[str, str], dict[str, Any]] = {
        ("dashscope", "wan2.7-i2v"): {
            ...
            "contract_issues": [
                "Xinzhi Video AI UI exposes first-frame image-to-video; asset-based workflow can optionally pass narration audio as driving_audio.",
    ...
    async def _generate_image(
        ...
        **params,
        ...
        from xinzhi_video_ai.services.api_services.image_client import ImageClient
        ...
        session_id = params.get("session_id") or "xinzhi_ai"
    ...
    async def _generate_video(
        ...
        **params,
        ...
        from xinzhi_video_ai.services.api_services.video_client import VideoClient
...
""".strip()
    ...
    def _video_options(
        ...
        """Map Xinzhi Video AI's generic video params to provider client options."""
