...
from xinzhi_video_ai.utils.tts_util import edge_tts
from xinzhi_video_ai.tts_voices import speed_to_rate
...
class TTSService(ComfyBaseService):
    ...
    Usage:
        ...
        audio_path = await xinzhi_video_ai.tts(text="Hello, world!")
        
        # Use specific workflow
        audio_path = await xinzhi_video_ai.tts(
            text="你好，世界！",
            workflow="tts_edge.json"
        )
        
        # List available workflows
        workflows = xinzhi_video_ai.tts.list_workflows()
    """
