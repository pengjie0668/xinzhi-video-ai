...
class MediaService(ComfyBaseService):
    ...
    Usage:
        ...
        media = await xinzhi_video_ai.media(
            prompt="a cat",
            workflow="image_flux.json"
        )
        
        # List available workflows
        workflows = xinzhi_video_ai.media.list_workflows()
    """
    ...
    def __init__(self, config: dict, core=None):
        ...
        Args:
            ...
            core: XinzhiVideoAICore instance (for accessing shared ComfyKit)
        """
    ...
    def _scan_workflows(self):
        ...
        """
        from xinzhi_video_ai.utils.os_util import list_resource_dirs, list_resource_files, get_resource_path
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            media = await xinzhi_video_ai.media(prompt="a beautiful cat")
            if media.is_image:
