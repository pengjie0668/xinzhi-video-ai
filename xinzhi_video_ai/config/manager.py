...
from .schema import XinzhiVideoAIConfig
...
class ConfigManager:
    ...
    def __init__(self, config_path: str = "config.yaml"):
        ...
        self.config: XinzhiVideoAIConfig = self._load()
        self._initialized = True
    
    def _load(self) -> XinzhiVideoAIConfig:
        """Load configuration from file"""
        data = load_config_dict(str(self.config_path))
        config = XinzhiVideoAIConfig(**data)
    ...
    def update(self, updates: dict):
        ...
        self.config = XinzhiVideoAIConfig(**merged)
