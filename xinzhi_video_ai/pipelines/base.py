...
from xinzhi_video_ai.models.storyboard import VideoGenerationResult
...
class BasePipeline(ABC):
    ...
    def __init__(self, xinzhi_video_ai_core):
        ...
        Args:
            xinzhi_video_ai_core: XinzhiVideoAICore instance (provides access to all services)
        """
        self.core = xinzhi_video_ai_core
        
        # Quick access to services (convenience)
        self.llm = xinzhi_video_ai_core.llm
        self.tts = xinzhi_video_ai_core.tts
        self.media = xinzhi_video_ai_core.media
        self.video = xinzhi_video_ai_core.video
        
        # Backward compatibility alias
        self.image = xinzhi_video_ai_core.media
