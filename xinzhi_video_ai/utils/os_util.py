...
Provides utilities for managing paths and files in Xinzhi Video AI.
Inspired by the upstream MCP utility module's os_util.py.
"""
...
def get_xinzhi_video_ai_root_path() -> str:
    """
    Get Xinzhi Video AI root path
    
    Uses XINZHI_VIDEO_AI_ROOT environment variable to determine project root.
    ...
    env_root = os.environ.get("XINZHI_VIDEO_AI_ROOT")
...
def ensure_xinzhi_video_ai_root_path() -> str:
    """
    Ensure Xinzhi Video AI root path exists and return the path
    
    Returns:
        Root path as string
    """
    root_path = get_xinzhi_video_ai_root_path()
...
def get_root_path(*paths: str) -> str:
    """
    Get path relative to Xinzhi Video AI root path
    ...
    """
    root_path = ensure_xinzhi_video_ai_root_path()
    if paths:
...
def get_temp_path(*paths: str) -> str:
    """
    Get path relative to Xinzhi Video AI temp folder
...
def get_data_path(*paths: str) -> str:
    """
    Get path relative to Xinzhi Video AI data folder
...
def get_output_path(*paths: str) -> str:
    """
    Get path relative to Xinzhi Video AI output folder
