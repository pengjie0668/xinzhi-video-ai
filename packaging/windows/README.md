...
Automated build system for creating Windows portable packages of Xinzhi Video AI.
...
```
dist/windows/
├── Xinzhi Video AI-v*-win64/             # Build directory (version number varies)
│   ├── python/                         # Python embedded
│   ├── tools/                          # FFmpeg, etc.
│   ├── Xinzhi Video AI/                  # Project files
...
├── Xinzhi Video AI-v*-win64.zip          # ZIP package (version number varies)
└── Xinzhi Video AI-v*-win64.zip.sha256   # Checksum (version number varies)
```
...
```bash
# Windows PowerShell
Get-FileHash Xinzhi Video AI-v*-win64.zip -Algorithm SHA256
```
...
Same as Xinzhi Video AI project license.
