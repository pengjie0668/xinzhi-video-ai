...
class ActionTransferPipelineUI(PipelineUI):
    ...
    def render(self, xinzhi_video_ai: Any):
        ...
        # ====================================================================
        with left_col:
            video_params = self.render_action_transfer_video_input(xinzhi_video_ai)
            render_version_info()
        ...
        # ====================================================================
        with middle_col:
            assets_params = self.render_action_transfer_assets_input(xinzhi_video_ai)
    ...
    def render_action_transfer_video_input(self, xinzhi_video_ai) -> dict:
    ...
    def render_action_transfer_assets_input(self, xinzhi_video_ai) -> dict:
        with st.container(border=True):
