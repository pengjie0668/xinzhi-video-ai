...
from xinzhi_video_ai.utils.os_util import create_task_output_dir
...
class DigitalHumanPipelineUI(PipelineUI):
    ...
    def render(self, xinzhi_video_ai: Any):
        ...
        with left_col:
            ...
            style_params = render_style_config(xinzhi_video_ai)
        ...
        with middle_col:
            # Style configuration ()
            workflow_path = self.workflow_path_config(xinzhi_video_ai)
    ...
    def workflow_path_config(self, xinzhi_video_ai: Any) -> dict:
        ...
        with st.container(border=True):
            ...
            api_image_workflows = list_api_media_workflows(xinzhi_video_ai, "image")
                ...
                try:
                    ...
                    async def generate_digital_human_video():
                        ...
                        async def generate_tts_reference(text: str) -> str:
                            ...
                            await xinzhi_video_ai.tts(**tts_kwargs)
                            return audio_path
                        ...
                        async def generate_api_digital_human(text: str) -> str:
                            ...
                            media_result = await xinzhi_video_ai.media(**media_params)
                        ...
                        if api_video_workflow:
                            if mode == "customize":
                                ...
                                generated_text = await xinzhi_video_ai.llm(
                                    prompt=(
                        ...
                        kit = await xinzhi_video_ai._get_or_create_comfykit()
                        ...
                        if mode == "customize":
                            ...
                            if goods_text and goods_text.strip():
                                ...
                                if api_image_workflow:
                                    ...
                                    media_result = await xinzhi_video_ai.media(
                                        prompt=image_prompt,
