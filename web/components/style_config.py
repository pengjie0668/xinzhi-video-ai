...
def render_style_config(xinzhi_video_ai):
    ...
    with st.container(border=True):
        ...
        # ================================================================
            ...
            tts_workflows = xinzhi_video_ai.tts.list_workflows()
            ...
            if st.button(tr("tts.preview_button"), key="preview_tts", use_container_width=True):
                with st.spinner(tr("tts.previewing")):
                    try:
                        ...
                        audio_path = run_async(xinzhi_video_ai.tts(**tts_params))
    ...
    with st.container(border=True):
        ...
        from xinzhi_video_ai.utils.template_util import get_templates_grouped_by_size_and_type, get_template_type
        ...
        template_config = xinzhi_video_ai.config.get("template", {})
        ...
        from xinzhi_video_ai.utils.template_util import parse_template_size
        ...
        from xinzhi_video_ai.utils.template_util import resolve_template_path
        ...
        from xinzhi_video_ai.utils.template_util import get_template_type
        ...
        with st.expander(tr("template.preview_title"), expanded=False):
            ...
            from xinzhi_video_ai.utils.template_util import parse_template_size, resolve_template_path
    ...
    if template_requires_media:
        ...
        with st.container(border=True):
            ...
            all_workflows = xinzhi_video_ai.media.list_workflows()
            ...
            with st.expander(preview_title, expanded=False):
                ...
                if st.button(preview_button_label, key="preview_style", use_container_width=True):
                    ...
                    with st.spinner(previewing_text):
                        try:
                            from xinzhi_video_ai.utils.prompt_helper import build_image_prompt
                            ...
                            media_result = run_async(xinzhi_video_ai.media(
                                prompt=final_prompt,
                        ...
                        if st.button(tr("style.video_preview"), key="preview_standard_video", use_container_width=True):
                            with st.spinner(tr("style.video_previewing")):
                                try:
                                    ...
                                    first_frame_result = run_async(xinzhi_video_ai.media(
                                        prompt=final_prompt,
                                        workflow=workflow_key,
                                        media_type="image",
                                        width=int(media_width),
                                    ...
                                    preview_video = run_async(xinzhi_video_ai.media(
                                        prompt=final_prompt,
