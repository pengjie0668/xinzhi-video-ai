...
1. 访问 [GitHub Releases](https://github.com/pengjie0668/xinzhi-video-ai/releases/latest) 下载最新版本
...
浏览器应该会自动打开 `http://localhost:8501`，显示 芯智未来 AI 视频引擎 的 Web 界面。
