...
1. **[安装 芯智未来 AI 视频引擎](getting-started/installation.md)** - 下载并安装项目
   - 🪟 **Windows 用户推荐**: 使用 [一键整合包](https://github.com/pengjie0668/xinzhi-video-ai/releases/latest)，无需安装 Python 环境
...
- 🐛 **遇到问题**: 提交 [Issue](https://github.com/pengjie0668/xinzhi-video-ai/issues)
- 💡 **功能建议**: 提交 [Feature Request](https://github.com/pengjie0668/xinzhi-video-ai/issues)
...
本项目采用 Apache 2.0 许可证，详情请查看 [LICENSE](https://github.com/pengjie0668/xinzhi-video-ai/blob/main/LICENSE) 文件。
