...
This page will guide you through installing Xinzhi Video AI.
...
1. Visit [GitHub Releases](https://github.com/pengjie0668/xinzhi-video-ai/releases/latest) to download the latest version
...
```bash
git clone https://github.com/pengjie0668/xinzhi-video-ai.git
cd xinzhi-video-ai
```
...
Your browser should automatically open `http://localhost:8501` and display the Xinzhi Video AI web interface.
