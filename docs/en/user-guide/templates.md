...
Video templates use HTML to define the layout and style of video frames. Xinzhi Video AI provides multiple preset templates covering different video dimensions and style requirements.
...
For template development questions, feel free to ask in [GitHub Issues](https://github.com/pengjie0668/xinzhi-video-ai/issues).
